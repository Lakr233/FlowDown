...
public class Storage {
    ...
    func clearLocalData() throws {
        try db.run(transaction: {
            ...
            try $0.delete(fromTable: ChatTemplateObject.tableName)
        ...
        DispatchQueue.global(qos: .utility).async { [weak self] in
            ...
            do {
                ...
                try db.run(transaction: {
                    ...
                    try $0.delete(fromTable: ChatTemplateObject.tableName, where: ChatTemplateObject.Properties.modified <= deleteAt && ChatTemplateObject.Properties.removed == true)
        ...
        do {
            ...
            try exportStorage.db.run { [self] expdb in
                do {
                    ...
                    let templates: [ChatTemplateObject] = try db.getObjects(fromTable: ChatTemplateObject.tableName)
                    try expdb.insert(templates, intoTable: ChatTemplateObject.tableName)
                    return true
                } catch {
                    getError = error
                    return false
