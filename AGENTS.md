...
- Treat Catalyst entitlement changes as signing-profile migrations; keep the notarization profile in sync and validate a signed archive before publishing the next release.
